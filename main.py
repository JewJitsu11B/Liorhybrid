...
def start_training(config):
    ...
    if torch.cuda.is_available():
        ...
        print("")
        print("To fix, reinstall PyTorch with CUDA 13.0:")
        print("  pip3 uninstall torch torchvision torchaudio")
        print("  pip3 install \"torch==2.10.0+cu130\" --index-url https://download.pytorch.org/whl/cu130 --extra-index-url https://pypi.nvidia.com")
        print("If NVIDIA pip packages are blocked/firewalled, allow access to pypi.nvidia.com")
        print("=" * 70)
        raise RuntimeError("GPU required but CUDA not available. Install torch==2.10.0+cu130 and NVIDIA CUDA runtime pip deps.")
