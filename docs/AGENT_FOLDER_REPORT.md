...
## models/
- SOTA Attention: Standard transformers rely on positional encodings; models/ integrates geometric stacks and LIoR kernels with manifold-aware metrics.
...
## training/
- SOTA Attention: Typical trainers focus on loss/optimizer; this folder enforces device invariants, geometric costs, and free→nudged contrastive physics loops.
...
- JAMBA: Hybrid configs center on MoE/SSM routing; here scripts wire physics modes and audits.
